# CSC207 Week 1 Lab Activity #1: Fizz Buzz... WOOHOO!
...
strike you as either similar to or different from Python.
   - Closes out chunks using {}
   - Java uses &&
   - Java uses ; as opposed to commas in the parameters in the for loop
   - Java uses ; to close out lines
   - // For comments
   - Printing is System.out.printLn("Fizz Buzz")
   - else if instead of elif and using () after
